...
- ~~[UltraAmplifiedDimension-Fabric 10.0.0+1.17.1](https://modrinth.com/mod/ultra-amplified-dimension-fabric/version/qWOEJ7RV)~~ Removed temporarily due to memleaks on vanilla test server
