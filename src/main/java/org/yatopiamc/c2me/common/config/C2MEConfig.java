...
public class C2MEConfig {
    ...
    public static class AsyncIoConfig {
        ...
        public AsyncIoConfig(CommentedConfig config) {
            ...
            this.ioWorkerParallelism = ConfigUtils.getValue(configScope, "ioWorkerParallelism", () -> Math.min(10, Runtime.getRuntime().availableProcessors()), "Serializer executor parallelism", ConfigUtils.CheckType.THREAD_COUNT);
            configScope.removeUnusedKeys();
        }
    }
