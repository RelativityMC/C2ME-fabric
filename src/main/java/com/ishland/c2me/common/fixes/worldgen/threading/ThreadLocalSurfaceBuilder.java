...
public class ThreadLocalSurfaceBuilder<C extends SurfaceConfig> extends SurfaceBuilder<C> {
    ...
    @Override
    public void generate(Random random, BlockColumn chunk, Biome biome, int x, int z, int height, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, int i, long seed, C config) {
