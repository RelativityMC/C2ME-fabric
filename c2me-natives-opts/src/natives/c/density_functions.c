...
double c2me_natives_dfi_bindings_single_op(const density_function_impl_data *dfi, int blockX, int blockY, int blockZ) {
    return dfi->single_op(dfi->instance, blockX, blockY, blockZ);
}

void
c2me_natives_dfi_bindings_multi_op(const density_function_impl_data *dfi, density_function_multi_pos_args_data *dfa,
...
void c2me_natives_dfi_bindings_multi_op_provided(const density_function_impl_data *dfi, noise_pos *poses, double *res,
                                                 size_t length) {
